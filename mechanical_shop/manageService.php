...
<div>
          <div class="row">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php
                    $count=1;
                    $qs1=mysqli_query($con,"SELECT * FROM `tbl_mech_services` WHERE `Mid`='$lid'")or die("Sign in Error");
                    if(mysqli_num_rows($qs1)>0)
                    {
                     ...
                     $sid=$sv['Sno'];
                     $Mtype=$sv['MType'];
                     $s1=mysqli_query($con,"SELECT * FROM `tbl_services` WHERE `Sno`='$sid'")or die("Sign in Error");
                    ...
                    if($sv['MType']==2)
                    {
                      echo "<td>Two Wheeler</td>";
                    }
                    elseif ($sv['MType']==4) {
                      echo "<td>Four Wheeler</td>";
                    }
                    else {
                      echo "<td>Heavy Vehicle</td>";
                    }
                    ?>
                    <!-- <td><?php echo $sv['MType']; ?></td> -->
        						<td><?php echo $s5['Sname']; ?></td>
        						<td>
                      <!-- <a class="editPolice1" data-target="#editPoliceModel1" id="<?php echo $sv['Fsno']; ?>" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="View More">&#xE254;</i></a> -->

                      <?php
                      if($sv['status'])
                      {
                      ?>
                      <a href="#" id="<?php echo $sv['Msno']; ?>" class="delete deleteService" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                      <?php
                      }
                      else {
                        ?>
                        <a href="#reModel" id="<?php echo $sv['Msno']; ?>" class="reassig reassignService" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Make as Active">autorenew</i></a>
                        <?php
                      }
                    }
                      ?>
                ...
                <?php
                  ...
                  ?>
                  <tr>
                  <td colspan="4"><center>Not Services Added !!!!</center></td>
                  </tr>
                  <?php
                  }
                  ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="AddMechService.php" method="post">
      <div class="modal-body">
        <center>
          <p id="sel2" style="visibility:hidden;">All Services are Selected</p>
        </center>
                             <table class="table">
                                                 <tbody>
                                                   <tr>
                                                       <th valign="top">Type of Vehicle:</th>
                                                       <td>
                                                       <select name="Stype" id="Stype" class="form-control form-control-solid ng-untouched ng-pristine ng-invalid" required="">
                                                 ...
                                                 <tr id="sel1">
                                                     <th valign="top">Select Service:</th>
                                                     <td>
                                                     <select name="Sfor" id="Sfor" class="form-control form-control-solid ng-untouched ng-pristine ng-invalid" required="">
                                                     <option value="">--Select--</option>
                                                     <?php
                                                     $s2=mysqli_query($con,"SELECT * FROM `tbl_services` WHERE `Sfor`='mech' AND `status`=1")or die("Sign in Error");
                                                    if(mysqli_num_rows($s2)>0)
                                                    {
                                                      while($sv = mysqli_fetch_array($s2))
                                                      {

                                                        ?>
                                                         <option value="<?php echo $sv['Sno']; ?>"><?php echo $sv['Sname']; ?></option>
                                                        <?php
                                                      }
                                                    }
