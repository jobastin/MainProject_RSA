...
<div>
          <div class="row">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php
                    $count=1;
                    $qs1=mysqli_query($con,"SELECT * FROM `tbl_fuel_service` WHERE `Fid`='$lid'")or die("Sign in Error");
                    ...
                    ?>
                      ...
                      {
                      ?>
                      <a href="#" id="<?php echo $sv['Fsno']; ?>" class="delete deleteService" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                      <?php
                      }
                      else {
                        ?>
                        <a href="#reModel" id="<?php echo $sv['Fsno']; ?>" class="reassig reassignService" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Make as Active">autorenew</i></a>
                        <?php
                      }
                    }
                      ?>
                ...
                <?php
                  ...
                  ?>
                  <tr>
                  <td colspan="3"><center>Not Services Added !!!!</center></td>
                  </tr>
                  <?php
                  }
                  ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="AddFuelService.php" method="post">
      <div class="modal-body">
        <center>
          <p id="sel2" style="visibility:hidden;">All Services are Selected</p>
                             ...
                             <table class="table">
                                                 ...
                                                 <tr id="sel1">
                                                     ...
                                                     <?php
                                                     $s2=mysqli_query($con,"SELECT * FROM `tbl_services` WHERE `Sfor`='fuel' AND `status`=1")or die("Sign in Error");
                                                    if(mysqli_num_rows($s2)>0)
                                                    {
                                                      while($sv = mysqli_fetch_array($s2))
                                                      {
                                                        $s3=mysqli_query($con,"SELECT * FROM `tbl_fuel_service` WHERE `Sno`='$sv[Sno]' and `Fid`='$lid'")or die("Sign in Error");
