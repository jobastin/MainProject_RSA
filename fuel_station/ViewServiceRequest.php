              ...
              $s = mysqli_fetch_array($qs2);
               ...
               ?>
                <table class="table table-striped table-hover">
                    ...
                    $qs2=mysqli_query($con,"SELECT * FROM `tbl_fuel_service_request` WHERE `Fid`='$fid' ORDER BY `req_id` desc")or die("Sign in Error");
                    ...
                    ?>
        					  <tr>
        						<td><?php echo "R".$s['req_id']; ?></td>
        						<td><?php echo $s5['Sname']; ?></td>
                    <td><?php echo $s['description']; ?></td>
                    <?php
                    $uid=$s['user_id'];
                    $s2=mysqli_query($con,"SELECT * FROM `tbl_user` WHERE `login_id`='$uid'")or die("Sign in Error");
                    while($s3 = mysqli_fetch_array($s2))
                    {
                    ?>
                    <td><?php echo $s3['name']; ?></td>
                    <td><?php echo $s3['phone']; ?></td>
                    <td><?php echo $s['comment']; ?></td>
                      ...
                      {
                      ?>
                      <a href="#" id="<?php echo $s['req_id']; ?>" class="checkService" data-toggle="modal" data-target="#exampleModal1"><i class="material-icons" data-toggle="tooltip" title="Generate Bill">check</i></a>

                      <!-- <a href="#" class="editPolice" data-target="#editPoliceModel" id="<?php echo $s['req_id']; ?>" data-toggle="modal" data-lat1="<?php echo $s['lat']; ?>" data-lng1="<?php $s['log']; ?>"><i class="material-icons" data-toggle="tooltip" title="Edit">pin_drop</i></a> -->

                      <a href="#" id="<?php echo $s['req_id']; ?>" class="delete deleteService" data-toggle="modal" data-target="#exampleModal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                      <a href="#editPoliceModel" id="<?php echo $s['req_id']; ?>" class="direction" data-toggle="modal" onclick="calcRoute(<?php echo $s['lat']; ?>,<?php echo $s['log']; ?>)"><i class="material-icons" data-toggle="tooltip" title="Get Direction">directions</i></a>
                      <?php
                      }
                    }
                  }
                ...
                <?php
                  ...
                  ?>
                  <tr>
                  <td colspan="7"><center>No Service Requested.... !!!</center></td>
                  </tr>
                  <?php
                  }
                  ?>
