        ...
        <div class="row">
              ...
              <table class="table table-striped table-hover">
                    ...
                    <th>Action</th>
        				...
        				<tbody id="myTable">
              <?php
                    $qs2=mysqli_query($con,"SELECT * FROM `tbl_hospital`")or die("Sign in Error");
                    ...
                    ?>
        					  <tr>
        						<td><?php echo $sv2['Hname']; ?></td>
        						<td><?php echo $sv2['Hemail']; ?></td>
        						<td><?php echo $sv2['Hphno']; ?></td>
        						<td><?php echo $sv2['Hadd']; ?></td>
                    <td><?php echo $sv2['Hpin']; ?></td>
        						<td>
                      <a href="#" id="<?php echo $sv2['login_id']; ?>" class="HosViewMore" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="View More">remove_red_eye</i></a>
                      <a href="#" data-target="#HosViewMapModel" id="<?php echo $sv2['login_id']; ?>" class="HosViewMap"  data-toggle="modal" data-lat="<?php echo $sv2['Hlat']; ?>" data-lng="<?php echo $sv2['Hlon']; ?>"><i class="material-icons" data-toggle="tooltip" title="View on Map">location_on</i></a>
                      <a href="#" id="<?php echo $sv2['login_id']; ?>" class="HosSendMail" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Send a Mail">mail</i></a>
                      <?php
                      if($sv2['Hstatus'])
                      {
                      ?>
                      <a href="#" id="<?php echo $sv2['login_id']; ?>" class="delete deleteHos" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                      <?php
                      }
                      else {
                        ?>
                        <a href="#reModel" id="<?php echo $sv2['login_id']; ?>" class="reassig reassignHos" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Make as Active">autorenew</i></a>
                        <?php
                      }
                      ?>
                    </td>
...
<div id="HosViewMoreModel" class="modal fade">
<div class="modal-dialog">
		<div class="modal-content">
			<form method="post">
				...
				<div class="modal-body" id="HosViewMoreBody">
...
<div id="HosViewMapModel" class="modal fade">
<div class="modal-dialog">
		<div class="modal-content">
			<form method="post">
				<div class="modal-header">
				...
				<div class="modal-body" id="HosViewMapBody">
...
<!-- Mech view on Map Modal  -->
<div id="HosSendMailModel" class="modal fade">
<div class="modal-dialog">
		<div class="modal-content">
			<form method="post" id="form8">
				...
				<div class="modal-body" id="HosSendMailBody">
          ...
          <h3>To : </h3>
          <fieldset>
          <input class="form-control" value="" disabled="true" type="text" name="email3" id="email3" tabindex="2" required>
          </fieldset>
          <br>
          <br>
          <fieldset>
          <input placeholder="Enter the Subject" class="form-control" type="text" name="emailSub2" id="emailSub2" tabindex="2" required>
          </fieldset>
          <br>
          <br>
          <fieldset>
          <textarea placeholder="Type your Message Here...." id="emailBody2"  class="form-control" name="emailBody2" tabindex="5" required></textarea>
          </fieldset>
          <br>
          <br>
          <fieldset>
   ...
   $('.HosViewMore').click(function() {
      var h_id = $(this).attr("id");
       $.ajax({
               ...
               data:{h_id:h_id},
               success:function(data){
                    $('#HosViewMoreBody').html(data);
                    $('#HosViewMoreModel').modal("show");
               }
          });
   });
});
...
//                data:{m_id:m_id},
//                success:function(data){
//                     $('#HosViewMapBody').html(data);
//                     $('#HosViewMapModel').modal("show");
//                }
//           });
//    });
// });
   ...
   $('.HosSendMail').click(function() {
      e_id = $(this).attr("id");
       $.ajax({
               ...
               success:function(data){
                    $("#email3").val(data);
                    $('#HosSendMailModel').modal("show");
               }
          });
   });
   $("#form8").submit(function (event) {
     var sub = $("#emailSub2").val();
     var body= $("#emailBody2").val();
     $.ajax({
             url:"HosMail.php",
             method:"post",
...
$(document).ready(function() {
  ...
  $('#HosViewMapModel').on('show.bs.modal', function(event) {
  ...
  $('#HosViewMapModel').on('shown.bs.modal', function() {
