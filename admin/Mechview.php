        ...
        <div class="row">
              ...
              <table class="table table-striped table-hover">
                    ...
                    <th>Action</th>
        				...
        				<tbody id="myTable">
              <?php
                    $qs1=mysqli_query($con,"SELECT * FROM `tbl_mech`")or die("Sign in Error");
                    ...
                    ?>
        					  <tr>
        						<td><?php echo $sv['Mname']; ?></td>
        						<td><?php echo $sv['Memail']; ?></td>
        						<td><?php echo $sv['Mphno']; ?></td>
        						<td><?php echo $sv['Mowner']; ?></td>
                    <td><?php echo $sv['MOphno']; ?></td>
        						<td>
                      <a href="#" id="<?php echo $sv['login_id']; ?>" class="MechViewMore" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="View More">remove_red_eye</i></a>
                      <a href="#" data-target="#MechViewMapModel" id="<?php echo $sv['login_id']; ?>" class="MechViewMap"  data-toggle="modal" data-lat="<?php echo $sv['Mlat']; ?>" data-lng="<?php echo $sv['Mlong']; ?>"><i class="material-icons" data-toggle="tooltip" title="View on Map">location_on</i></a>
                      <a href="#" id="<?php echo $sv['login_id']; ?>" class="MechSendMail" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Send a Mail">mail</i></a>
                      <?php
                      if($sv['Mstatus'])
                      {
                      ?>
                      <a href="#" id="<?php echo $sv['login_id']; ?>" class="delete deleteMech" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                      <?php
                      }
                      else {
                        ?>
                        <a href="#reModel" id="<?php echo $sv['login_id']; ?>" class="reassig reassignMech" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Make as Active">autorenew</i></a>
                        <?php
                      }
                      ?>
                    </td>
...
<div id="MechViewMoreModel" class="modal fade">
<div class="modal-dialog">
		<div class="modal-content">
			<form method="post">
				...
				<div class="modal-body" id="MechViewMoreBody">
...
$(document).ready(function(){
   var r_id;
   $('.reassignMech').click(function() {
      var r_id = $(this).attr("id");
       $.ajax({
               url:"MechReassign.php",
               method:"post",
               data:{r_id:r_id},
               success:function(data){
                  location.reload();
